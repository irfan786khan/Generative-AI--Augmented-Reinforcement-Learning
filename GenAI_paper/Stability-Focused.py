...
def train_dqn(env, agent, n_episodes=2000, max_t=30, eps_start=1.0, eps_end=0.01, eps_decay=0.998):
    ...
    return scores, losses, best_stability_per_episode, episode_stability_trends
...
def create_research_plots(best_stability_per_episode, episode_stability_trends, test_stabilities, test_env):
    ...
    plt.savefig('updated_research_plots.pdf', format='pdf', dpi=300, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    scores, losses, best_stability_per_episode, episode_stability_trends = train_dqn(train_env, agent, n_episodes=2000)
    ...
    print("Training completed and research plots saved!")